...
@section('content')
    <h1 class="p-3 bg-dark text-white">Edit a comic</h1>
        ...
        <form action="{{ route('comics.update', $comic) }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title"
                    aria-describedby="titleHelper" placeholder="Title" value="{{ old('title', $comic->title) }}" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('cover_image') is-invalid @enderror" name="cover_image"
                    ...
                    value="{{ old('cover_image', $comic->title) }}" />
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('author') is-invalid @enderror" name="author"
                    id="author" aria-describedby="authorHelper" placeholder="Name"
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('publication_year') is-invalid @enderror"
                    ...
                    placeholder="2024" value="{{ old('publication_year', $comic->publication_year) }}" />
